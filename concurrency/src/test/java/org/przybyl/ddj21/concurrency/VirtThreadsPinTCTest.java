...
class VirtThreadsPinTCTest {
    ...
    public void shouldNotPin() throws IOException, InterruptedException {
        ...
        var bulkDataFile = MountableFile.forClasspathResource("bulk.data");
        ...
        try (
            var elasticsearch = new ElasticsearchContainer("docker.elastic.co/elasticsearch/elasticsearch:8.12.1")
                .withCopyFileToContainer(bulkDataFile, "/tmp/bulk.data")
